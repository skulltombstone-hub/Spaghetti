...
<p align="center">
  A universal game launcher for Android.
</p>

## About

Spaghetti is an open-source Android application designed to provide a unified platform for running games created on different engines, frameworks and consoles
...
### Current Supported Engines and Consoles
...
Currently, Spaghetti suporte HTML games and sites with parcial compatibility.

Thais is a WIP, but is already on the app.

### Engines and Consoles Coming Soon
...
### Planned Engines and Consoles

#### RPG Maker XP (very long-term goal)
#### RPG Maker VX (very long-term goal)
#### RPG Maker VX Ace (very long-term goal)
#### RPG Maker MV (very long-term goal)
...
- Preserve games and interactive experiences
- Provide modern Android compatibility for PC engines older consoles
- Create a unified launcher for multiple game platforms
